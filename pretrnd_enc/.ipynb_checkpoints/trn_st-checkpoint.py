...
#Please provide the path for the pretrained src field from the translation
SRC = load_field(os.path.join("", 'src.field'))
#TRG = load_field(os.path.join("../../simple_translation/wmt_translation", 'trg.field'))
...
train_pos_iterator, valid_pos_iterator, test_pos_iterator, test_neg_iterator = BucketIterator.splits(
    (train_pos_data, valid_pos_data, test_pos_data, test_neg_data),
    batch_size = BATCH_SIZE,
...
#Please provide the translation checkpoint here.
